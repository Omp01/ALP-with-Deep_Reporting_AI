...
class AssessmentItem(Base):
    """
    Assessment item with psychometric parameters (IRT / difficulty / discrimination).
    """
    ...
    question_type = Column(String(50), default="multiple_choice", nullable=False)  # multiple_choice, multi_select, true_false, open_ended
    options = Column(JSONB, default=list, nullable=False)  # List of choices
