"""
Semantic Text Chunker with Token Count Estimation.
"""
...
class SemanticChunker:
    ...
    def chunk_text(self, text: str) -> List[Dict[str, Any]]:
        ...
        Returns: list of dicts with keys: chunk_index, text_content, token_count
        """
            ...
            if current_count + word_count <= self.target_chunk_size:
                ...
                if current_chunk_words:
                    ...
                    chunks.append({
                        ...
                        "token_count": int(len(current_chunk_words) * 1.3),  # rough token approx
                    })
                    chunk_idx += 1
                    ...
                    # Single paragraph exceeds chunk size: split by words
